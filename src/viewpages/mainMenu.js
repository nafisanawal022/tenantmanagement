...
function MainMenu() {
    ...
    return (
        ...
        <div className="main">
            ...
            <br></br>
            <h1 style={{ color: 'white', fontWeight: 'bold', fontFamily: 'Arial, sans-serif', textTransform: 'uppercase', fontSize: '50px' }}>Rahman's Residence</h1>
            <div class="nav-links">
                <ul>
            ...
            <div className="controls">
                ...
                ></img>
                <h3 style={{ color: 'white', fontWeight: 'bold', fontFamily: 'Arial, sans-serif', textTransform: 'uppercase' }}>Navigate</h3>
